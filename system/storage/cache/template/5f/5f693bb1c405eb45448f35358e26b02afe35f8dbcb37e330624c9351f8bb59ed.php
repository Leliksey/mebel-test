...
class __TwigTemplate_2a0518cca0a5a7c4f2a2ba0e635edd5a59f9aa382f653d58c57f85f20db7e49d extends Template
{
    private $source;
    private $macros = [];
        ...
        if (($context["downloads"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["download"]) {
                ...
                if (twig_get_attribute($this->env, $this->source, $context["download"], "extension_install_id", [], "any", false, false, false, 70)) {
                    ...
                    echo "</button>
                        ";
                } elseif ((0 === twig_compare(twig_slice($this->env, twig_get_attribute($this->env, $this->source,                 // line 72
