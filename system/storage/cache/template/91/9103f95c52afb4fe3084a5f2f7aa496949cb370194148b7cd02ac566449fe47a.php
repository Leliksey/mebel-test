...
class __TwigTemplate_f1ef7f7c5ef8a7975ac67961692cf2ec109f5245c1b4b560287722cf4e64f7d2 extends Template
{
    private $source;
    private $macros = [];
          ...
          <div class=\"tab-content\">
            ...
            <div class=\"tab-pane\" id=\"tab-store\">
              ...
              <div class=\"form-group required\">
                ...
                <div class=\"col-sm-10\">
                  <input type=\"text\" name=\"config_telephone2\" value=\"{{ config_telephone }}\" placeholder=\"{{ entry_telephone2 }}\" id=\"input-telephone2\" class=\"form-control\" />
                  {% if error_telephone %}
                  <div class=\"text-danger\">{{ error_telephone }}</div>
                  {% endif %} </div>
              </div>
