...
class __TwigTemplate_ee30acca086e49d5c54e3bc8360676e0f13ea6916e0430c831d2e314aeec9287 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"btn-group\">
      ...
      ";
            ...
            // line 9
            echo "      <span class=\"hidden-xs hidden-sm hidden-md lang_current\">";
...
";
  ...
  <form action=\"{{ action }}\" method=\"post\" enctype=\"multipart/form-data\" id=\"form-language\">
    <div class=\"btn-group\">
      ...
      {% endif %}
      {% endfor %}
      <span class=\"hidden-xs hidden-sm hidden-md lang_current\">{{ text_language }}</span></button>
      <ul class=\"dropdown-menu\">
        {% for language in languages %}
        {% if language.code != code %} 
        <li>
