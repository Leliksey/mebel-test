...
class __TwigTemplate_c832ee56fb4c8c2dfdec1222af238263c4b4be495cb0fdba4607ff4599bbe7ae extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      <div class=\"col-md-9 col-md-pull-3 col-sm-12\">
        ...
        echo "</td>
                      <td class=\"text-left\">";
        // line 152
        if ((0 === twig_compare(($context["sort"] ?? null), "p.status"))) {
            echo " <a href=\"";
        ...
        if (($context["products"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                echo "</td>
                    <td class=\"text-right\">";
                // line 174
                if ((0 >= twig_compare(twig_get_attribute($this->env, $this->source, $context["product"], "quantity", [], "any", false, false, false, 174), 0))) {
                    echo " <span class=\"label label-warning\">";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "quantity", [], "any", false, false, false, 174);
                    echo "</span> ";
                } elseif ((0 >= twig_compare(twig_get_attribute($this->env, $this->source, $context["product"], "quantity", [], "any", false, false, false, 174), 5))) {
...
//--></script></div>
{{ footer }} ", "catalog/product_list.twig", "");
    }
}
