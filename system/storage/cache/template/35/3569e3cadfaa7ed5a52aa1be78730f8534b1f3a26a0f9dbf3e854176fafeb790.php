...
class __TwigTemplate_13c14535248a6d95270342510b5c3ab482b297437580fee26dbc37738eb9b2bc extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t";
                // line 277
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable((($__internal_compile_2 = ($context["module_custom_cart"] ?? null)) && is_array($__internal_compile_2) || $__internal_compile_2 instanceof ArrayAccess ? ($__internal_compile_2["list"] ?? null) : null));
...
\t\t\t\t\t\t\t\t\t\t\t";
                    // line 281
                    if ((0 === twig_compare($context["column"], $context["name"]))) {
                        echo "\t
\t\t\t\t\t\t\t\t\t\t\t\t";
                        // line 282
...
\t\t\t\t\t\t\t";
        // line 312
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((($__internal_compile_3 = ($context["module_custom_cart"] ?? null)) && is_array($__internal_compile_3) || $__internal_compile_3 instanceof ArrayAccess ? ($__internal_compile_3["list"] ?? null) : null));
        foreach ($context['_seq'] as $context["name"] => $context["item"]) {
            echo " 
\t\t\t\t\t\t\t\thtml += '<option value=\"";
            // line 313
...
\t\t\t\t\t\t\t\t\t\t";
                ...
                foreach ($context['_seq'] as $context["name"] => $context["item"]) {
                    ...
                    // line 358
                    echo "\t\t\t\t\t\t\t\t\t\t\t";
                    if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["field"], "name", [], "any", false, false, false, 358), $context["name"]))) {
                        // line 359
                        echo "\t\t\t\t\t\t\t\t\t\t\t\t";
                        $context["selected"] = "selected=\"selected\"";
                        // line 360
...
\t\t\t\t\t\t\t\t\t\t\t";
                ...
                foreach ($context['_seq'] as $context["name"] => $context["item"]) {
                    ...
                    // line 491
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t";
                    if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["field"], "name", [], "any", false, false, false, 491), $context["name"]))) {
                        // line 492
                        echo "\t\t\t\t\t\t\t\t\t\t\t\t\t";
                        $context["selected"] = "selected=\"selected\"";
                        // line 493
...
\t\t\t\t\t\t\t\t\t\t\t";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    ...
                    // line 609
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t";
                    if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["item"], "code", [], "any", false, false, false, 609), twig_get_attribute($this->env, $this->source, $context["method"], "name", [], "any", false, false, false, 609)))) {
                        // line 610
                        echo "\t\t\t\t\t\t\t\t\t\t\t\t\t";
                        $context["selected"] = "selected=\"selected\"";
                        // line 611
