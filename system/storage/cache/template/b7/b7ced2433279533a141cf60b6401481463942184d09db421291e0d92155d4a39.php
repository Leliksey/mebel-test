...
class __TwigTemplate_3a269e38967ae9d398f8533aa78fd9840de2d0ef8ca8aa91b884a7bb092e8735 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        echo " </div>
              ...
              <div class=\"form-group required\">
                <label class=\"col-sm-2 control-label\" for=\"input-telephone2\">";
        // line 141
        echo ($context["entry_telephone2"] ?? null);
        echo "</label>
                <div class=\"col-sm-10\">
                  <input type=\"text\" name=\"config_telephone2\" value=\"";
        // line 143
        echo ($context["config_telephone2"] ?? null);
        echo "\" placeholder=\"";
        echo ($context["entry_telephone2"] ?? null);
        echo "\" id=\"input-telephone2\" class=\"form-control\" />
                  ";
        // line 144
        if (($context["error_telephone"] ?? null)) {
            // line 145
        ...
        <form action=\"{{ action }}\" method=\"post\" enctype=\"multipart/form-data\" id=\"form-setting\" class=\"form-horizontal\">
          ...
          <div class=\"tab-content\">
            ...
            <div class=\"tab-pane\" id=\"tab-store\">
              ...
              <div class=\"form-group required\">
                <label class=\"col-sm-2 control-label\" for=\"input-telephone2\">{{ entry_telephone2 }}</label>
                <div class=\"col-sm-10\">
                  <input type=\"text\" name=\"config_telephone2\" value=\"{{ config_telephone2 }}\" placeholder=\"{{ entry_telephone2 }}\" id=\"input-telephone2\" class=\"form-control\" />
                  {% if error_telephone %}
                  <div class=\"text-danger\">{{ error_telephone }}</div>
                  {% endif %} </div>
              </div>
