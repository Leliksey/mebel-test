...
class __TwigTemplate_a4811feea22598a4dae37829df7b5a50d21cc5f6143eb1f3a46afe63068fc0cf extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
                ...
                echo "\"><img src=\"";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "thumb", [], "any", false, false, false, 211);
                echo "\" alt=\"\"></a>
\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
...
\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 215
                if (twig_get_attribute($this->env, $this->source, $context["product"], "option", [], "any", false, false, false, 215)) {
                    // line 216
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["product"], "option", [], "any", false, false, false, 216));
...
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                ...
                // line 221
                echo "\t\t\t\t\t\t\t\t\t\t\t\t";
                if (twig_get_attribute($this->env, $this->source, $context["product"], "recurring", [], "any", false, false, false, 221)) {
                    // line 222
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t\t<br/>
\t\t\t\t\t\t\t\t\t\t\t\t\t-<small>";
                    // line 223
                    ...
                    echo " ";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "recurring", [], "any", false, false, false, 223);
                    echo "</small>
\t\t\t\t\t\t\t\t\t\t\t\t";
                }
                // line 225
                ...
                echo "</td>
                                            <td>";
                // line 228
                echo twig_get_attribute($this->env, $this->source, $context["product"], "total", [], "any", false, false, false, 228);
                echo "</td>
                                            <td>
                                                <button class=\"btn btn-danger\" type=\"button\"  onclick=\"cart.remove('";
                // line 230
                echo twig_get_attribute($this->env, $this->source, $context["product"], "cart_id", [], "any", false, false, false, 230);
...
\t\t\t<div class=\"modal-footer\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["total"]) {
            ...
            // line 246
            echo twig_get_attribute($this->env, $this->source, $context["total"], "title", [], "any", false, false, false, 246);
            echo "</strong></td>
                        <td class=\"text-right\">";
            // line 247
            echo twig_get_attribute($this->env, $this->source, $context["total"], "text", [], "any", false, false, false, 247);
            echo "</td>
                    </tr>
                    ";
        }
...
";
    ...
    {
        return array (  535 => 285,  527 => 274,  500 => 252,  494 => 251,  491 => 250,  482 => 247,  478 => 246,  475 => 245,  471 => 244,  465 => 240,  459 => 238,  453 => 234,  443 => 230,  438 => 228,  434 => 227,  430 => 226,  427 => 225,  420 => 223,  417 => 222,  414 => 221,  411 => 220,  401 => 218,  398 => 217,  393 => 216,  391 => 215,  385 => 214,  377 => 211,  373 => 209,  369 => 208,  364 => 205,  362 => 204,  352 => 197,  343 => 191,  316 => 169,  310 => 168,  300 => 160,  292 => 158,  282 => 155,  277 => 154,  275 => 153,  265 => 145,  242 => 119,  168 => 47,  159 => 45,  154 => 44,  143 => 42,  138 => 41,  129 => 39,  124 => 38,  111 => 36,  107 => 35,  90 => 20,  84 => 18,  81 => 17,  75 => 15,  73 => 14,  69 => 13,  65 => 12,  55 => 7,  47 => 4,  41 => 3,  37 => 1,);
    }
...
\t\t\t\t\t\t\t\t\t\t\t</td>
                                            ...
                                            <td>{{ product.total }}</td>
                                            <td>
                                                <button class=\"btn btn-danger\" type=\"button\"  onclick=\"cart.remove('{{ product.cart_id }}');\"><i class=\"fa fa-times\"></i></button>
                                            </td>
\t\t\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t\t\t{% endfor %}
\t\t\t\t\t\t\t\t</tbody>
