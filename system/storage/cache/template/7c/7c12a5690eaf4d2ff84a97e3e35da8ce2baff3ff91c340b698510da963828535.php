...
class __TwigTemplate_603c54be13ff4f805bf4bac4d28b9d80381ab7590dba0a88290decb859025421 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["geo_zone"]) {
            // line 40
            echo "                ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["geo_zone"], "geo_zone_id", [], "any", false, false, false, 40), ($context["shipping_free_geo_zone_id"] ?? null)))) {
                // line 41
                echo "                <option value=\"";
...
{{ footer }} ", "extension/shipping/free.twig", "");
    }
}
